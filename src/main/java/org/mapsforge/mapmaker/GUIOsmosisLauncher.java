...
public class GUIOsmosisLauncher {
	...
	public static void main(String[] args) {
		System.out.println("== mapsforge map maker v"
				+ GUIOsmosisLauncher.class.getPackage().getImplementationVersion() + " ==");
	...
	private static void invokeOsmosisAsync(final IDialogSettings settings) {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				System.out.println("[OsmosisThread] Waiting for pipeline to finish");
	...
	private static void printSettings(IDialogSettings settings) {
		...
		System.out.println("Enable debug file: " + mapFileSection.getBoolean("enableDebugFile"));
